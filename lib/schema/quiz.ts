...
export const QuizQuestionSchema = z.object({
  ...
  status: z.enum(['not_attempted', 'attempted', 'passed_once', 'review_soon', 'review_later', 'mastered']).optional(),
...
export const IncorrectAnswerLogEntrySchema = z.object({
  ...
  incorrectSelections: z.array(z.object({
...
// Validation helpers
export const validateQuizModule = (data: unknown): { success: true; data: QuizModule } | { success: false; error: z.ZodError } => {
  try {
