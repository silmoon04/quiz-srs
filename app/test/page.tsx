...
export default function TestPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Markdown Parser Tests</h1>
      ...
      <div className="mt-8">
        <h2 className="text-xl font-bold mb-4">Test Data Preview</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h3 className="font-semibold mb-2">Format 1: Options/Correct</h3>
            <pre className="bg-gray-50 p-3 text-xs overflow-auto max-h-64">{testMarkdown1}</pre>
          </div>
          <div>
            <h3 className="font-semibold mb-2">Format 2: Opt/Ans</h3>
            <pre className="bg-gray-50 p-3 text-xs overflow-auto max-h-64">{testMarkdown2}</pre>
          </div>
        </div>
      </div>
    </div>
