...
- **Editing UI dead**: Question editor component exists but no trigger to open/save/delete. Inline edits impossible post-refactor. (components/quiz-session.tsx, components/question-editor.tsx)
